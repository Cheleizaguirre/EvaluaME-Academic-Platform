...
namespace Mudul.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(DefaultdbContext context, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, ApplicationDbContext contextIdentity)
        {
        ...
        // GET: AdminController/TeacherManagement
        ...
        // POST: AdminController/TeacherEdit
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: AdminController/TeacherCreate
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminController/StudentManagement
        ...
        // POST: AdminController/StudentEdit
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: AdminController/StudentDelete
        [HttpPost]
        ...
        // GET: AdminController/SubjectManagement
        ...
        // POST: AdminController/SubjectEdit
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: AdminController/SubjectDelete
        [HttpPost]
